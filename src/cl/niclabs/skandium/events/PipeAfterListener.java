 ...
 * {@link When#AFTER} {@link cl.niclabs.skandium.skeletons.Pipe} event.
 * 
 * @param <P> <code>param</code> type before {@link cl.niclabs.skandium.skeletons.Pipe} is executed
 * @param <R> <code>param</code> type after {@link cl.niclabs.skandium.skeletons.Pipe} is executed
 */
public abstract class PipeAfterListener<P,R> extends NoParamListener<R> implements PipeListener<P,R>, AfterListener, SkeletonListener {
