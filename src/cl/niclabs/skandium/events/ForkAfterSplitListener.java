 ...
 * {@link cl.niclabs.skandium.skeletons.Fork} {@link When#AFTER} {@link Where#SPLIT} event.
 * 
 ...
 */
public abstract class ForkAfterSplitListener<P,X,Y,R> extends NoParamListener<X[]> implements ForkListener<P,X,Y,R>, AfterListener, SplitListener {
