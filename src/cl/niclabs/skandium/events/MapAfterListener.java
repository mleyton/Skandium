 ...
 * {@link When#AFTER} {@link cl.niclabs.skandium.skeletons.Map} event.
 * 
 ...
 */
public abstract class MapAfterListener<P,X,Y,R> extends NoParamListener<R> implements MapListener<P,X,Y,R>, AfterListener, SkeletonListener {
